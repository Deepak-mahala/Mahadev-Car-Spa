    ...
    <>
        ...
        <div className="overlay">
         ...
         <div id="main-Heading">
          ...
          <Button className="px-20 md:px-30 py-5 text-2xl font-bold rounded-lg primaryRed1 text-white cursor-pointer hover:" onClick={() => window.open("https://wa.me/+918209913189", "_blank")}> Book Now </Button>         
          </div>
         </div>
